...
namespace SentimentAnalysis_Service
{
    public partial class MLModel
    {
        ...
        public class ModelInput
        {
            ...
            public float Is_depression { get; set; }
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"is_depression")]
            public uint Is_depression { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("is_depression");
            if (labelColumn == null)
            {
                throw new Exception("is_depression column not found. Make sure the name searched for matches the name in the schema.");
            }
